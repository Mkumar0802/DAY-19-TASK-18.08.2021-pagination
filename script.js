...
container.setAttribute("class", "container first")
document.body.append(container)
const table1 = document.createElement("div")
table1.setAttribute("class", "container  second")
...
function head() {
    ...
    column11.setAttribute("class", "col-2 ")
    column11.innerHTML = `<h4>Id</h4>`
    row1.appendChild(column11)
    const column21 = document.createElement("div")
    column21.setAttribute("class", "col-5")
    column21.innerHTML = `<h4>Name</h4>`
    row1.appendChild(column21)
    const column31 = document.createElement("div")
    column31.setAttribute("class", "col-5")
    column31.innerHTML = `<h4>Email</h4>`
    row1.appendChild(column31)
}
...
<ul class="pagination ">
  <li class="page-item">
    <a class="page-link" onclick="pages(12)" aria-label="Previous">
      <span aria-hidden="true">&laquo;</span>
    </a>
  </li>
  <li class="page-item"><a class="page-link p1" onclick="pages(1)" >1</a></li>
  <li class="page-item"><a class="page-link p1" onclick="pages(2)" >2</a></li>
  <li class="page-item"><a class="page-link p1" onclick="pages(3)" >3</a></li>
  <li class="page-item"><a class="page-link p1" onclick="pages(4)" >4</a></li>
  <li class="page-item"><a class="page-link p1" onclick="pages(5)" >5</a></li>
  <li class="page-item"><a class="page-link p1" onclick="pages(6)" >6</a></li>
  <li class="page-item"><a class="page-link p1" onclick="pages(7)" >7</a></li>
  <li class="page-item"><a class="page-link p1" onclick="pages(8)" >8</a></li>
  <li class="page-item"><a class="page-link p1" onclick="pages(9)" >9</a></li>
  <li class="page-item"><a class="page-link p1" onclick="pages(10)">10</a></li>
  <li class="page-item">
    <a class="page-link" onclick="pages(11)" aria-label="Next">
...
function table() {
    ...
    column1.innerText = `${person_id}`
    row.appendChild(column1)
    const column2 = document.createElement("div")
    column2.setAttribute("class", "col-5")
    column2.innerText = `${person_name}`
    row.appendChild(column2)
    const column3 = document.createElement("div")
    column3.setAttribute("class", "col-5")
    column3.innerText = `${person_email}`
...
function pages(b) {
    ...
    switch (b) {
        ...
        case 9: a = 80; break;
        case 10: a = 90; break;
        case 11: if (a < 100) a = a + 10; break;
        case 12: if (a > 0) a = a - 10; break;
